...
dev_data = [
    ...
    ("7. 工艺管理", "工艺参数仿真", "CFD流体仿真集成、参数模拟预测", 15, 20, 45), # Boosted significantly
    ...
    ("9. 质量管理", "缺陷视觉识别", "外观缺陷CNN图像识别模型训练", 10, 15, 30), # Boosted
    ("9. 质量管理", "QMS质量分析", "SPC统计过程控制、全链条质量追溯", 12, 18, 10),

    # 5.10 Online Experiment
    ("10. 在线试验", "高级排程系统", "基于资源约束的APS高级排程算法", 15, 20, 25), # Boosted
    ...
    ("12. 科研助手", "科研知识图谱", "文献解析、百万级实体抽取、RAG构建", 10, 15, 45), # Boosted
    ("12. 科研助手", "生成式AI应用", "智能摘要、多语种翻译、辅助写作Agent", 10, 15, 30), # Boosted
]
...
with pd.ExcelWriter(output_file, engine='openpyxl') as writer:
    ...
    title_cell.value = "数字化研发业务平台 - 详细开发预算表 (高阶版)"
